...
public class Dice implements DiceInterface {
	 ...
	 * @param mini The minimum number you can roll.
	 * @param maxi The maximum number you can roll.
	 * @see Dice#maximum
	 * @see Dice#minimum
	 */
	 ...
	 * @param mini An integer representing the minimum number to roll.
	 * @see Dice#minimum
	 */
	 ...
	 * @param maxi An integer representing the maximum number to roll.
	 * @see Dice#maximum
	 */
	 ...
	 * @param obj An object to compare to the dice.
